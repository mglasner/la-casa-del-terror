...
const ENEMIGOS = {
        ...
        [
            {
                nombre: 'Golpe sucio',
                dano: 7,
                descripcion: 'Un golpe bajo y traicionero',
                arquetipo: 'carga',
                color: '#2d5a1e',
                colorSecundario: '#6b4423',
            },
            {
                nombre: 'Trampa',
                dano: 10,
                descripcion: 'Trampa escondida en el suelo',
                arquetipo: 'aoe',
                color: '#6b4423',
                colorSecundario: '#2d5a1e',
                radio: 2,
            },
        ],
        {
    ...
    Topete: new Enemigo(
        ...
        [
            ...
            },
            {
                nombre: 'Cadenazo',
                dano: 10,
                descripcion: 'Golpe con las cadenas rotas',
                arquetipo: 'carga',
                color: '#aaaaaa',
    ...
    Pototo: new Enemigo(
        ...
        [
            {
                nombre: 'Risa burlesca',
                dano: 8,
                descripcion: 'Carcajada tan fuerte que aturde',
                arquetipo: 'aoe',
                color: '#8e44ad',
                colorSecundario: '#2c003e',
                radio: 2,
            },
            {
