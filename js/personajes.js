...
const PERSONAJES = {
        ...
        [
            {
                nombre: 'Nota aguda',
                dano: 15,
                descripcion: 'Un agudo que aturde al rival',
                arquetipo: 'proyectil',
                color: '#d4a0ff',
                colorSecundario: '#9b59b6',
            },
            {
    ...
    Hana: new Personaje(
        ...
        [
            ...
            {
                nombre: 'Coreografía letal',
                dano: 22,
                descripcion: 'Movimientos mortales de baile',
                arquetipo: 'aoe',
                color: '#ff69b4',
                colorSecundario: '#e91e90',
                radio: 3,
            },
        ],
        {
